...
function Home() {
  var hadleChangeSlider = function hadleChangeSlider(swiper) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_8___default()('.slider_menu > .swiper-wrapper').children().removeClass('active'); // $('.slider_menu > .swiper-wrapper').children(index).addClass('active');
  };
