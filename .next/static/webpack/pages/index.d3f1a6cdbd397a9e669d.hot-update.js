...
function Home() {
  var hadleChangeSlider = function hadleChangeSlider(swiper) {
    ...
    console.log(jquery__WEBPACK_IMPORTED_MODULE_8___default()('.swiper-container')[1]);
  };
