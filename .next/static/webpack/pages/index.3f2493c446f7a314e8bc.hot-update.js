...
function Home() {
  var hadleChangeSlider = function hadleChangeSlider(swiper) {
    ...
    var slide = jquery__WEBPACK_IMPORTED_MODULE_8___default()('.swiper-wrapper')[1].children();
    console.log(slide);
  };
