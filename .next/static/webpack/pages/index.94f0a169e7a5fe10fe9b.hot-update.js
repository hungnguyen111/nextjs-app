...
function Home() {
  if (true) {
    jquery__WEBPACK_IMPORTED_MODULE_6___default()('#navbar-box__local').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_6___default()('#dropdown-menu').slideToggle(); // console.log(display);
