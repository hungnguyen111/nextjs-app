...
function Home() {
  ...
  if (true) {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_6___default()('#navbar-box__local').on('click', function () {
      ...
      localStorage.setItem('flag', _flag); // let _flag = localStorage.getItem('flag');
      // console.log(_flag);
