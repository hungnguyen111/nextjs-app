...
function Home() {
  if (true) {
    jquery__WEBPACK_IMPORTED_MODULE_6___default()('#navbar-box__local1').on('click', function () {
      jquery__WEBPACK_IMPORTED_MODULE_6___default()('#dropdown-menu2').toggle();
      jquery__WEBPACK_IMPORTED_MODULE_6___default()('#header-overlay').toggle();
      console.log('sdfsd');
    });
  }
